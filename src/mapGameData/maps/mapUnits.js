...
module.exports = async(gameVersion, localeVersion, assetVersion)=>{
  ...
  await mongo.set('autoComplete', {_id: 'nameKeys'}, { include: false, 'data.unit': 'unit', 'data.leader': 'unit', 'data.unit1': 'unit', 'data.unit2': 'unit', 'data.unit3': 'unit', 'data.unit4': 'unit', 'data.exclude-attack-unit': 'unit', 'data.faction': 'faction' })
